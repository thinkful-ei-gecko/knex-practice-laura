...
// knexInstance('table_name').insert([{ name: 'foo' }, { name: 'bar' }]) OR...
...
// NOTE: with a password it would be:
// TEST_DB_URL="postgresql://dunder_mifflin:password-here@localhost/knex-practice-test"
  before(() => db('blogful_articles').truncate());
  afterEach(() => db('blogful_articles').truncate());
  after('destroy connection', () => db.destroy());

  context('When data is present', () => {
    beforeEach(() => { return db.into('blogful_articles').insert(testArticles) });
    it('returns all articles with getAllArticles()', () => {
